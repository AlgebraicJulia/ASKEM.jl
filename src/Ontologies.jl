module Ontologies
export infectious_ontology, vector_borne_ontology, vaccine_manufacture_ontology
...
const infectious_ontology = strip_names(
  LabelledPetriNet(
    [:Pop],
...
const vector_borne_ontology = strip_names(
  LabelledPetriNet(
    [:Host, :Vector],
...
const vaccine_manufacture_ontology = strip_names(
  LabelledPetriNet(
    [:Pop, :Vaccine],
    :produce=>(() => :Vaccine),
